...
void Hand::drawThumbFinger(float _skin_color[3], ModelStack &modelStack, Shaders &shader)
{
	...
	if (_attribut == "right") draw_paving_shape({-0.021f, -0.007f, -0.0114f}, {0.007f, 0.007f, 0.0114f}, _skin_color, shader, modelStack);
	else draw_paving_shape({0.021f, -0.007f, -0.0114f}, {-0.007f, 0.007f, 0.0114f}, _skin_color, shader, modelStack);
	...
	draw_paving_shape({-0.001f,  -0.001f, 0.001f}, { 0.001f, 0.001f, -0.001f}, red, shader, modelStack); //debug
	if (_attribut == "right") draw_paving_shape({-0.0217f, -0.007f, -0.0114f}, {0.01f, 0.007f, 0.0114f}, _skin_color, shader, modelStack);
	else draw_paving_shape({0.0217f, -0.007f, -0.0114f}, {-0.01f, 0.007f, 0.0114f}, _skin_color, shader, modelStack);
