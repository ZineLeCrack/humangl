...
{
	if (_showWings == true) {
		draw_rect({a.x, a.y * _size * _body_size, a.z}, {b.x, b.y * _size * _body_size, a.z}, color, 0, 0, 0, 0, false, shader, modelStack);
		draw_rect({a.x, a.y * _size * _body_size, b.z}, {b.x, b.y * _size * _body_size, b.z}, color, 0, 0, 0, 0, false, shader, modelStack);

		draw_rect({a.x, a.y * _size * _body_size, a.z}, {a.x, b.y * _size * _body_size, b.z}, color, 0, 0, 0, 0, false, shader, modelStack);
		draw_rect({b.x, a.y * _size * _body_size, a.z}, {b.x, b.y * _size * _body_size, b.z}, color, 0, 0, 0, 0, false, shader, modelStack);

		draw_rect({a.x, a.y * _size * _body_size, a.z}, {b.x, a.y * _size * _body_size, b.z}, color, 0, 0, 0, 0, false, shader, modelStack);
		draw_rect({a.x, b.y * _size * _body_size, a.z}, {b.x, b.y * _size * _body_size, b.z}, color, 0, 0, 0, 0, false, shader, modelStack);
	}
}
